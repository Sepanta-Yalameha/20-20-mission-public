        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 -mt-16 relative z-10">
          ...
          <div className="bg-white p-8 rounded-lg shadow-xl text-center">
            ...
            <div className="flex justify-center space-x-4">
              <a href="https://www.instagram.com/20.20.mission" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-secondary transition-colors">
              ...
              <a href="https://www.linkedin.com/company/20-20-mission-foundation" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-secondary transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
